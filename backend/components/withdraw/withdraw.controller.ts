...
export default {
  ...
  getWithdrawForShop: async (req: Request, res: Response) => {
    ...
    new OKResponse({ message: "Withdraw request for shop fetched succesfully", metadata: requests }).send(res);
  },
  ...
  getAllWithdraw: async (req: Request, res: Response) => {
    ...
    new OKResponse({ message: "Withdraw request fetched succesfully", metadata: requests }).send(res);
  },
  //get by id
  getWithdrawById: async (req: Request, res: Response) => {
    ...
    new OKResponse({ message: "Withdraw request fetched succesfully", metadata: { request } }).send(res);
  },
