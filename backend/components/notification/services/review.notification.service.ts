...
class ReviewNotificationService {
  static async createAndSendNewReviewNotification(reviewId: number, socket?: Socket) {
    ...
    await notificationIoServive.createAndSend(new ReviewNotification(userId, payload), socket);
  }
}
